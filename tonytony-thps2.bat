...
sleep 2
start /b .\Bizhawk\output\EmuHawk.exe \roms\thps2.z64 --lua="./scripts/tonytony-thps2.lua" --config="./scripts/tonytony-thps2-mod.ini"
start /b .\Bizhawk\output\EmuHawk.exe .\roms\mario.z64 --config="./scripts/tonytony-mario-mod.ini"
