...
sleep 2
start /b .\BizHawk\EmuHawk.exe \roms\thps2.z64 --lua="./scripts/tonytony-thps2.lua" --config="./scripts/tonytony-thps2-mod.ini"
start /b .\BizHawk\EmuHawk.exe .\roms\mario.z64 --config="./scripts/tonytony-mario-mod.ini"
